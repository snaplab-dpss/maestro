...
int dmap_locks_allocate(map_keys_equality *eq_a, map_key_hash *hsh_a,
  ...
  struct DoubleMapLocks *map_alloc =
      (struct DoubleMapLocks *)rte_malloc(NULL, sizeof(struct DoubleMapLocks), 64);
  if (map_alloc == NULL)
    return 0;
  *map_out = (struct DoubleMapLocks *)map_alloc;
  uint8_t *vals_alloc = (uint8_t *)rte_malloc(NULL, (uint32_t)value_size * capacity, 64);
  if (vals_alloc == NULL) {
    rte_free(map_alloc);
    *map_out = old_map_val;
    return 0;
  ...
  int *bbs_a_alloc = (int *)rte_malloc(NULL, sizeof(int) * (int)keys_capacity, 64);
  if (bbs_a_alloc == NULL) {
    rte_free(vals_alloc);
    rte_free(map_alloc);
    *map_out = old_map_val;
  ...
  void **kps_a_alloc = (void **)rte_malloc(NULL, sizeof(void *) * (int)keys_capacity, 64);
  if (kps_a_alloc == NULL) {
  ...
  int *chns_a_alloc = (int *)rte_malloc(NULL, sizeof(int) * (int)keys_capacity, 64);
  ...
  int *inds_a_alloc = (int *)rte_malloc(NULL, sizeof(int) * (int)keys_capacity, 64);
  ...
  int *bbs_b_alloc = (int *)rte_malloc(NULL, sizeof(int) * (int)keys_capacity, 64);
  if (bbs_b_alloc == NULL) {
  ...
  void **kps_b_alloc = (void **)rte_malloc(NULL, sizeof(void *) * (int)keys_capacity, 64);
  if (kps_b_alloc == NULL) {
  ...
  int *inds_b_alloc = (int *)rte_malloc(NULL, sizeof(int) * (int)keys_capacity, 64);
  ...
  int *chns_b_alloc = (int *)rte_malloc(NULL, sizeof(int) * (int)keys_capacity, 64);

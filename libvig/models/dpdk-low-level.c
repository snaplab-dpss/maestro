...
void stub_prefetch(const volatile void *p) {
  // Nothing
}

const char *stub_strerror(int errnum) { return "<fake error description>"; }

void stub_abort(void) { klee_silent_exit(1); }

__attribute__((constructor)) static void stub_rte_init(void) {

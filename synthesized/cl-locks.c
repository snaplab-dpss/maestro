...
uint8_t hash_key_0[RSS_HASH_KEY_LENGTH] = {
  0xa2, 0x98, 0x43, 0x86, 0x99, 0x53, 0x94, 0x34, 
  0x61, 0x5b, 0x73, 0x92, 0x10, 0xa7, 0x12, 0x6c, 
  0x0, 0x40, 0xce, 0xd9, 0xd3, 0x2a, 0x16, 0x96, 
  0xd1, 0x17, 0xbc, 0x2c, 0x31, 0x79, 0x49, 0xd3, 
  0x11, 0x8c, 0x59, 0xab, 0xe0, 0xed, 0xdf, 0x41, 
  0x48, 0x53, 0xd3, 0x59, 0xfa, 0xe5, 0xc5, 0xfa, 
  0x26, 0x93, 0xd3, 0xf9
};
uint8_t hash_key_1[RSS_HASH_KEY_LENGTH] = {
  0xf2, 0x49, 0x70, 0x5a, 0xc5, 0xb, 0xdc, 0xf2, 
  0x10, 0x7f, 0x11, 0xae, 0xef, 0xd6, 0x40, 0x89, 
  0x9f, 0xc3, 0xdd, 0xb9, 0xba, 0x78, 0xd8, 0xd, 
  0xa4, 0x6e, 0xb4, 0x7b, 0xc, 0x30, 0xfa, 0xfe, 
  0x79, 0x6a, 0x59, 0x3f, 0x75, 0x35, 0x31, 0x86, 
  0xb5, 0x43, 0x34, 0xa4, 0x19, 0x74, 0x2e, 0xb8, 
  0x37, 0xb, 0x72, 0xf1
};
...
bool nf_init() {
  ...
  if (map_allocation_succeeded__1) {
    int vector_alloc_success__4 = vector_locks_allocate(13u, 65536u, flow_allocate, &vector);

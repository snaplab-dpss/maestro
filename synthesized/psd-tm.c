...
uint8_t hash_key_0[RSS_HASH_KEY_LENGTH] = {
  0xe4, 0x67, 0x31, 0xd7, 0xef, 0xbb, 0x5c, 0x7b, 
  0xbe, 0xb1, 0xc0, 0xe8, 0xca, 0x93, 0x12, 0x55, 
  0x82, 0x90, 0x9f, 0xb, 0x3b, 0x7e, 0x70, 0xb1, 
  0xab, 0xee, 0xd7, 0xd3, 0x7d, 0xdb, 0xd8, 0x61, 
  0x42, 0x9, 0x38, 0x32, 0xc4, 0x95, 0xad, 0x82, 
  0x46, 0x6d, 0x6a, 0x10, 0x0, 0x7c, 0x66, 0x83, 
  0xc, 0x5, 0x8e, 0x47
};
uint8_t hash_key_1[RSS_HASH_KEY_LENGTH] = {
  0x87, 0x93, 0x12, 0xdd, 0xeb, 0xaf, 0xb3, 0xb6, 
  0x7d, 0x71, 0xdc, 0x52, 0x8c, 0x88, 0xbf, 0x2f, 
  0x0, 0xce, 0x20, 0x9e, 0xd0, 0x38, 0x29, 0x92, 
  0x86, 0x40, 0x60, 0x6f, 0xbd, 0x23, 0xe4, 0x44, 
  0xb6, 0xf7, 0x22, 0xa2, 0xa6, 0xd5, 0x58, 0x24, 
  0x47, 0x34, 0x76, 0xd3, 0xbc, 0x35, 0x2, 0xbd, 
  0x3, 0x23, 0x5b, 0xd3
};
...
int nf_process(uint16_t device, uint8_t* packet, uint16_t packet_length, int64_t now) {
  ...
  if ((8u == ether_header_1->ether_type) & (20ul <= (4294967282u + packet_length))) {
    ...
    if (((6u == ipv4_header_1->next_proto_id) | (17u == ipv4_header_1->next_proto_id)) & ((4294967262u + packet_length) >= 4ul)) {
      ...
      int number_of_freed_flows__42 = expire_items_single_map_tm(dchain, vector, map, now - 10000000000ul);

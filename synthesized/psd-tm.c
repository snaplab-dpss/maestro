...
uint8_t hash_key_0[RSS_HASH_KEY_LENGTH] = {
  0x5d, 0x8a, 0x32, 0xc5, 0xb3, 0x2e, 0xfb, 0x37, 
  0x95, 0xa3, 0xce, 0xe5, 0x5b, 0x83, 0x74, 0xe8, 
  0x3a, 0x1b, 0x52, 0xd, 0x84, 0x72, 0xa5, 0x2d, 
  0x5d, 0x9d, 0xc6, 0x62, 0xb9, 0xff, 0xe2, 0x16, 
  0x89, 0x14, 0xdb, 0x3c, 0x42, 0xd6, 0x73, 0xd7, 
  0x79, 0x42, 0xbc, 0xd5, 0xc5, 0x30, 0xbd, 0xff, 
  0x4c, 0xf, 0xc, 0xd0
};
uint8_t hash_key_1[RSS_HASH_KEY_LENGTH] = {
  0xcf, 0x2f, 0x62, 0x6a, 0x21, 0xba, 0x1d, 0x6f, 
  0x91, 0x1, 0x5d, 0xec, 0x30, 0x4f, 0xc8, 0x16, 
  0x80, 0xd5, 0xee, 0x26, 0xc1, 0x71, 0x77, 0xd3, 
  0xf6, 0xcd, 0xc6, 0x9c, 0xf6, 0xe4, 0x51, 0xc6, 
  0x13, 0xb3, 0x30, 0x35, 0x6d, 0x4d, 0xa4, 0xfe, 
  0x4f, 0x1, 0xea, 0x7f, 0x50, 0xb2, 0x96, 0xd1, 
  0x87, 0x84, 0xf7, 0x48
};
  ...
  if (map_allocation_succeeded__1) {
    ...
    if (vector_alloc_success__4) {
      ...
      if (vector_alloc_success__7) {
        int is_dchain_allocated__10 = dchain_tm_allocate(65536u, &dchain);
        ...
        if (is_dchain_allocated__10) {
          ...
          if (map_allocation_succeeded__13) {
            int vector_alloc_success__16 = vector_allocate(6u, 4194304u, touched_port_allocate, &vector_2);
...
int nf_process(uint16_t device, uint8_t* packet, uint16_t packet_length, int64_t now) {
  ...
  if ((8u == ether_header_1->ether_type) & (20ul <= (4294967282u + packet_length))) {
    ...
    if (((6u == ipv4_header_1->next_proto_id) | (17u == ipv4_header_1->next_proto_id)) & ((4294967262u + packet_length) >= 4ul)) {
      ...
      int number_of_freed_flows__42 = expire_items_single_map_tm(dchain, vector, map, now - 100000000000ul);
      ...
      // 153
        ...
        if (0u == map_has_this_key__53) {
          ...
          int out_of_space__56 = !dchain_tm_allocate_new_index(dchain, &new_index__56, now);
          ...
          if (false == ((out_of_space__56) & (0u == number_of_freed_flows__42))) {
            ...
            int number_of_freed_flows__61 = expire_items_single_map_iteratively_tm(vector_2, map_1, new_index__56, ((int*)(vector_value_out_1))[0]);

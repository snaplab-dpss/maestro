...
uint8_t hash_key_0[RSS_HASH_KEY_LENGTH] = {
  0xc9, 0x95, 0x61, 0x59, 0x3f, 0xd2, 0xfe, 0x1e, 
  0xf7, 0xc8, 0xbd, 0x45, 0x89, 0xa2, 0xa9, 0xb6, 
  0x64, 0x6a, 0xc1, 0x9a, 0xd9, 0xa2, 0x11, 0x7e, 
  0xb1, 0x9c, 0x38, 0xa4, 0x94, 0xcb, 0xa1, 0x5d, 
  0x60, 0x3, 0xb6, 0x9f, 0xd5, 0xb4, 0xbd, 0xcc, 
  0x7c, 0x7b, 0x12, 0x5, 0x1d, 0xbb, 0xbc, 0x81, 
  0x25, 0x7d, 0x1b, 0xfe
};
uint8_t hash_key_1[RSS_HASH_KEY_LENGTH] = {
  0x78, 0x11, 0x11, 0xf7, 0x76, 0x81, 0x3, 0x28, 
  0x91, 0x3f, 0xbe, 0xd5, 0xa8, 0xf0, 0x11, 0x7b, 
  0x4f, 0x82, 0x30, 0x5f, 0xe7, 0xdf, 0xe9, 0xee, 
  0x2d, 0xa1, 0x85, 0x1d, 0x31, 0xb7, 0x64, 0xaa, 
  0xc8, 0x75, 0xa1, 0x3e, 0xf6, 0xa5, 0x66, 0x87, 
  0xe4, 0x24, 0x5d, 0x8c, 0x15, 0x6e, 0x7, 0x64, 
  0xf0, 0x38, 0xc3, 0xd7
};
  ...
  if ((8u == ether_header_1->ether_type) & (20ul <= (4294967282u + packet_length))) {
    ...
    if (((6u == ipv4_header_1->next_proto_id) | (17u == ipv4_header_1->next_proto_id)) & ((4294967262u + packet_length) >= 4ul)) {
      ...
      if (0u != device) {
        ...
        int map_value_out;
        int map_has_this_key__58 = map_locks_get(map, map_key, &map_value_out);
        ...
        if (0u == map_has_this_key__58) {
          ...
          int32_t prefered_backend_found__62 = cht_locks_find_preferred_available_backend(LoadBalancedFlow_hash__61, vector_4, dchain_1, 97u, 32u, &chosen_backend__62);
          ...
          // 269
            ...
            int out_of_space__73 = !dchain_locks_allocate_new_index(dchain, &new_index__73, now);
            ...
            if (false == ((out_of_space__73) & (0u == number_of_freed_flows__45))) {
              ...
              vector_locks_borrow(vector, new_index__73, (void**)(&vector_value_out));
              ...
              vector_locks_borrow(vector_1, new_index__73, (void**)(&vector_value_out_1));
              ...
              vector_locks_return(vector_1, new_index__73, vector_value_out_1);
              map_locks_put(map, vector_value_out, new_index__73);

              if (write_attempt_ptr[0] && (!write_state_ptr[0])) {
                return 1;
              }

              vector_locks_return(vector, new_index__73, vector_value_out);
              uint8_t* vector_value_out_2 = 0u;
              vector_locks_borrow(vector_3, chosen_backend__62, (void**)(&vector_value_out_2));
              vector_locks_return(vector_3, chosen_backend__62, vector_value_out_2);
            ...
            // 269
              ...
              uint8_t* vector_value_out = 0u;
              vector_locks_borrow(vector_3, chosen_backend__62, (void**)(&vector_value_out));
              vector_locks_return(vector_3, chosen_backend__62, vector_value_out);
        ...
        // 274
          ...
          int32_t dchain_is_index_allocated__125 = dchain_locks_is_index_allocated(dchain_1, ((int*)(vector_value_out))[0u]);
          ...
          // 274
            ...
            int map_value_out_1;
            int map_has_this_key__154 = map_locks_get(map, map_key_2, &map_value_out_1);
            uint8_t hashed_obj[13];
            hashed_obj[0u] = ipv4_header_1->src_addr & 0xff;
            hashed_obj[1u] = (ipv4_header_1->src_addr >> 8) & 0xff;
            hashed_obj[2u] = (ipv4_header_1->src_addr >> 16) & 0xff;
            ...
            int32_t prefered_backend_found__156 = cht_locks_find_preferred_available_backend(LoadBalancedFlow_hash__155, vector_4, dchain_1, 97u, 32u, &chosen_backend__156);
            ...
            // 274
              ...
              int out_of_space__167 = !dchain_locks_allocate_new_index(dchain, &new_index__167, now);
              ...
              uint8_t* vector_value_out_2 = 0u;
              vector_locks_borrow(vector, new_index__167, (void**)(&vector_value_out_2));
              ...
              vector_locks_borrow(vector_1, new_index__167, (void**)(&vector_value_out_3));
              ...
              vector_locks_return(vector_1, new_index__167, vector_value_out_3);
              map_locks_put(map, vector_value_out_2, new_index__167);

              if (write_attempt_ptr[0] && (!write_state_ptr[0])) {
                return 1;
              }

              vector_locks_return(vector, new_index__167, vector_value_out_2);
              uint8_t* vector_value_out_4 = 0u;
              vector_locks_borrow(vector_3, chosen_backend__156, (void**)(&vector_value_out_4));
              vector_locks_return(vector_3, chosen_backend__156, vector_value_out_4);
      ...
      // 277
        ...
        map_key[3u] = (ipv4_header_1->src_addr >> 24) & 0xff;
        int map_value_out;
        int map_has_this_key__194 = map_locks_get(map_1, map_key, &map_value_out);

        // 275
        // 276
        if (0u == map_has_this_key__194) {
          uint32_t new_index__197;
          int out_of_space__197 = !dchain_locks_allocate_new_index(dchain_1, &new_index__197, now);
          ...
          if (false == ((out_of_space__197) & (0u == number_of_freed_flows__46))) {
            ...
            uint8_t* vector_value_out = 0u;
            vector_locks_borrow(vector_3, new_index__197, (void**)(&vector_value_out));
            ...
            vector_locks_return(vector_3, new_index__197, vector_value_out);
            ...
            uint8_t* vector_value_out_1 = 0u;
            vector_locks_borrow(vector_2, new_index__197, (void**)(&vector_value_out_1));
            ...
            map_locks_put(map_1, vector_value_out_1, new_index__197);

            if (write_attempt_ptr[0] && (!write_state_ptr[0])) {
              return 1;
            }

            vector_locks_return(vector_2, new_index__197, vector_value_out_1);
            // dropping
            return device;
          }

...
uint8_t hash_key_0[RSS_HASH_KEY_LENGTH] = {
  0xe0, 0x72, 0x98, 0x78, 0xca, 0x5d, 0xd, 0x6d, 
  0xdc, 0x6a, 0x1a, 0xf8, 0xf5, 0xaa, 0xb5, 0x2c, 
  0x9, 0x3d, 0x7f, 0xf3, 0xfa, 0x75, 0x69, 0x2d, 
  0x4b, 0x39, 0x3a, 0xac, 0x55, 0xcb, 0x4f, 0x35, 
  0x3e, 0xe8, 0xad, 0x8, 0x45, 0xba, 0x75, 0x21, 
  0x25, 0x90, 0x1a, 0x1a, 0x3a, 0xcf, 0x47, 0x44, 
  0xc, 0xc6, 0x37, 0x6
};
uint8_t hash_key_1[RSS_HASH_KEY_LENGTH] = {
  0x64, 0x5d, 0x2e, 0x85, 0xf5, 0x34, 0x6d, 0x30, 
  0x32, 0xe6, 0x7e, 0xb5, 0xc7, 0x4d, 0x8a, 0x40, 
  0xc3, 0xaf, 0x23, 0x74, 0x80, 0x55, 0x72, 0x5f, 
  0x95, 0x35, 0x5c, 0x89, 0x41, 0x66, 0x28, 0xa5, 
  0xc3, 0x57, 0x2b, 0xb8, 0x8b, 0x98, 0xe8, 0xbd, 
  0x7e, 0x67, 0x72, 0x46, 0xb4, 0xfd, 0x86, 0x77, 
  0xac, 0xaa, 0xeb, 0x2c
};
...
bool nf_init() {
  ...
  int map_allocation_succeeded__1 = map_locks_allocate(LoadBalancedFlow_eq, LoadBalancedFlow_hash, 65536u, &map);
  ...
  if (map_allocation_succeeded__1) {
    int vector_alloc_success__4 = vector_locks_allocate(13u, 65536u, LoadBalancedFlow_allocate, &vector);
    ...
    if (vector_alloc_success__4) {
      int is_dchain_allocated__7 = dchain_locks_allocate(65536u, &dchain);
      ...
      if (is_dchain_allocated__7) {
        int vector_alloc_success__10 = vector_locks_allocate(4u, 65536u, null_init, &vector_1);
        ...
        if (vector_alloc_success__10) {
          int map_allocation_succeeded__13 = map_locks_allocate(ip_addr_eq, ip_addr_hash, 32u, &map_1);
          ...
          if (map_allocation_succeeded__13) {
            int vector_alloc_success__16 = vector_locks_allocate(4u, 32u, ip_addr_allocate, &vector_2);
            ...
            if (vector_alloc_success__16) {
              int vector_alloc_success__19 = vector_locks_allocate(12u, 32u, LoadBalancedBackend_allocate, &vector_3);
              ...
              if (vector_alloc_success__19) {
                int is_dchain_allocated__22 = dchain_locks_allocate(32u, &dchain_1);

                // 279
                // 280
                // 281
                if (is_dchain_allocated__22) {
                  int vector_alloc_success__25 = vector_locks_allocate(4u, 3104u, null_init, &vector_4);

                  // 279
                  // 280
                  if (vector_alloc_success__25) {
                    int cht_fill_cht_successful__28 = cht_locks_fill_cht(vector_4, 97u, 32u);
...
int nf_process(uint16_t device, uint8_t* packet, uint16_t packet_length, int64_t now) {
  bool* write_attempt_ptr = &RTE_PER_LCORE(write_attempt);
  bool* write_state_ptr = &RTE_PER_LCORE(write_state);
  int number_of_freed_flows__45 = expire_items_single_map_locks(dchain, vector, map, now - 100000000000ul);

  if (write_attempt_ptr[0] && (!write_state_ptr[0])) {
    return 1;
  }

  int number_of_freed_flows__46 = expire_items_single_map_locks(dchain_1, vector_2, map_1, now - 100000000000ul);
    ...
    if (((6u == ipv4_header_1->next_proto_id) | (17u == ipv4_header_1->next_proto_id)) & ((4294967262u + packet_length) >= 4ul)) {
      ...
      if (0u != device) {
        ...
        if (1u != device) {
          ...
          int map_value_out;
          int map_has_this_key__60 = map_locks_get(map, map_key, &map_value_out);
          ...
          if (0u == map_has_this_key__60) {
            ...
            int32_t prefered_backend_found__64 = cht_locks_find_preferred_available_backend(LoadBalancedFlow_hash__63, vector_4, dchain_1, 97u, 32u, &chosen_backend__64);
            ...
            // 295
              ...
              int out_of_space__75 = !dchain_locks_allocate_new_index(dchain, &new_index__75, now);
              ...
              if (false == ((out_of_space__75) & (0u == number_of_freed_flows__45))) {
                ...
                vector_locks_borrow(vector, new_index__75, (void**)(&vector_value_out));
                ...
                vector_locks_borrow(vector_1, new_index__75, (void**)(&vector_value_out_1));
                ...
                vector_locks_return(vector_1, new_index__75, vector_value_out_1);
                map_locks_put(map, vector_value_out, new_index__75);

                if (write_attempt_ptr[0] && (!write_state_ptr[0])) {
                  return 1;
                }

                vector_locks_return(vector, new_index__75, vector_value_out);
                uint8_t* vector_value_out_2 = 0u;
                vector_locks_borrow(vector_3, chosen_backend__64, (void**)(&vector_value_out_2));
                vector_locks_return(vector_3, chosen_backend__64, vector_value_out_2);
              ...
              // 295
                ...
                uint8_t* vector_value_out = 0u;
                vector_locks_borrow(vector_3, chosen_backend__64, (void**)(&vector_value_out));
                vector_locks_return(vector_3, chosen_backend__64, vector_value_out);
          ...
          // 300
            ...
            uint8_t* vector_value_out = 0u;
            vector_locks_borrow(vector_1, map_value_out, (void**)(&vector_value_out));
            vector_locks_return(vector_1, map_value_out, vector_value_out);
            int32_t dchain_is_index_allocated__121 = dchain_locks_is_index_allocated(dchain_1, ((int*)(vector_value_out))[0u]);
            ...
            if (dchain_is_index_allocated__121) {
              ...
              uint8_t* vector_value_out_1 = 0u;
              vector_locks_borrow(vector_3, ((int*)(vector_value_out))[0], (void**)(&vector_value_out_1));
              vector_locks_return(vector_3, ((int*)(vector_value_out))[0], vector_value_out_1);
            ...
            // 300
              ...
              uint8_t* vector_value_out_1 = 0u;
              vector_locks_borrow(vector, map_value_out, (void**)(&vector_value_out_1));
              ...
              uint8_t trash[13];
              map_locks_erase(map, &map_key_1, (void**)(&trash));

              if (write_attempt_ptr[0] && (!write_state_ptr[0])) {
                return 1;
              }

              dchain_locks_free_index(dchain, map_value_out);

              if (write_attempt_ptr[0] && (!write_state_ptr[0])) {
                return 1;
              }

              vector_locks_return(vector, map_value_out, vector_value_out_1);
              ...
              int map_value_out_1;
              int map_has_this_key__147 = map_locks_get(map, map_key_2, &map_value_out_1);
              uint8_t hashed_obj[13];
              hashed_obj[0u] = ipv4_header_1->src_addr & 0xff;
              hashed_obj[1u] = (ipv4_header_1->src_addr >> 8) & 0xff;
              hashed_obj[2u] = (ipv4_header_1->src_addr >> 16) & 0xff;
              ...
              int32_t prefered_backend_found__149 = cht_locks_find_preferred_available_backend(LoadBalancedFlow_hash__148, vector_4, dchain_1, 97u, 32u, &chosen_backend__149);
              ...
              // 300
                ...
                int out_of_space__160 = !dchain_locks_allocate_new_index(dchain, &new_index__160, now);
                ...
                uint8_t* vector_value_out_2 = 0u;
                vector_locks_borrow(vector, new_index__160, (void**)(&vector_value_out_2));
                ...
                vector_locks_borrow(vector_1, new_index__160, (void**)(&vector_value_out_3));
                ...
                vector_locks_return(vector_1, new_index__160, vector_value_out_3);
                map_locks_put(map, vector_value_out_2, new_index__160);

                if (write_attempt_ptr[0] && (!write_state_ptr[0])) {
                  return 1;
                }

                vector_locks_return(vector, new_index__160, vector_value_out_2);
                uint8_t* vector_value_out_4 = 0u;
                vector_locks_borrow(vector_3, chosen_backend__149, (void**)(&vector_value_out_4));
                vector_locks_return(vector_3, chosen_backend__149, vector_value_out_4);
        ...
        // 303
          ...
          map_key[3u] = (ipv4_header_1->src_addr >> 24) & 0xff;
          int map_value_out;
          int map_has_this_key__184 = map_locks_get(map_1, map_key, &map_value_out);

          // 301
          // 302
          if (0u == map_has_this_key__184) {
            uint32_t new_index__187;
            int out_of_space__187 = !dchain_locks_allocate_new_index(dchain_1, &new_index__187, now);
            ...
            if (false == ((out_of_space__187) & (0u == number_of_freed_flows__46))) {
              ...
              uint8_t* vector_value_out = 0u;
              vector_locks_borrow(vector_3, new_index__187, (void**)(&vector_value_out));
              ...
              vector_locks_return(vector_3, new_index__187, vector_value_out);
              ...
              uint8_t* vector_value_out_1 = 0u;
              vector_locks_borrow(vector_2, new_index__187, (void**)(&vector_value_out_1));
              ...
              map_locks_put(map_1, vector_value_out_1, new_index__187);

              if (write_attempt_ptr[0] && (!write_state_ptr[0])) {
                return 1;
              }

              vector_locks_return(vector_2, new_index__187, vector_value_out_1);
              // dropping
              return device;
            }
          ...
          // 303
            ...
            dchain_locks_rejuvenate_index(dchain_1, map_value_out, now);
            // dropping
            return device;
      ...
      // 306
        ...
        map_key[3u] = (ipv4_header_1->src_addr >> 24) & 0xff;
        int map_value_out;
        int map_has_this_key__220 = map_locks_get(map_1, map_key, &map_value_out);

        // 304
        // 305
        if (0u == map_has_this_key__220) {
          uint32_t new_index__223;
          int out_of_space__223 = !dchain_locks_allocate_new_index(dchain_1, &new_index__223, now);
          ...
          if (false == ((out_of_space__223) & (0u == number_of_freed_flows__46))) {
            ...
            uint8_t* vector_value_out = 0u;
            vector_locks_borrow(vector_3, new_index__223, (void**)(&vector_value_out));
            vector_value_out[0u] = device & 0xff;
            vector_value_out[1u] = (device >> 8) & 0xff;
            vector_value_out[2u] = ether_header_1->s_addr.addr_bytes[0ul];
            vector_value_out[3u] = ether_header_1->s_addr.addr_bytes[1ul];
            ...
            vector_value_out[10u] = (ipv4_header_1->src_addr >> 16) & 0xff;
            vector_value_out[11u] = (ipv4_header_1->src_addr >> 24) & 0xff;
            vector_locks_return(vector_3, new_index__223, vector_value_out);
            ...
            uint8_t* vector_value_out_1 = 0u;
            vector_locks_borrow(vector_2, new_index__223, (void**)(&vector_value_out_1));
            vector_value_out_1[0u] = ipv4_header_1->src_addr & 0xff;
            vector_value_out_1[1u] = (ipv4_header_1->src_addr >> 8) & 0xff;
            vector_value_out_1[2u] = (ipv4_header_1->src_addr >> 16) & 0xff;
            vector_value_out_1[3u] = (ipv4_header_1->src_addr >> 24) & 0xff;
            map_locks_put(map_1, vector_value_out_1, new_index__223);

            if (write_attempt_ptr[0] && (!write_state_ptr[0])) {
              return 1;
            }

            vector_locks_return(vector_2, new_index__223, vector_value_out_1);
            // dropping
            return device;
          }

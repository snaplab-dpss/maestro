...
uint8_t hash_key_0[RSS_HASH_KEY_LENGTH] = {
  0x50, 0x7e, 0x34, 0x48, 0x94, 0xc3, 0x16, 0x8c, 
  0xdb, 0x54, 0xfd, 0x99, 0x59, 0xf2, 0xb1, 0xf5, 
  0x50, 0xf2, 0xbc, 0xde, 0xa5, 0x72, 0x67, 0x1d, 
  0xea, 0xf9, 0xe0, 0xea, 0xa0, 0x87, 0x82, 0xf1, 
  0x5, 0xb6, 0x39, 0x99, 0x79, 0x4f, 0x25, 0x55, 
  0xa3, 0x22, 0xee, 0xfc, 0x15, 0x9f, 0xf1, 0x65, 
  0x91, 0xae, 0x43, 0x37
};
uint8_t hash_key_1[RSS_HASH_KEY_LENGTH] = {
  0x78, 0xdb, 0x4e, 0x9f, 0x12, 0x69, 0xaf, 0xc7, 
  0x9d, 0x6b, 0x20, 0x20, 0x58, 0x13, 0xd, 0x63, 
  0x66, 0xfd, 0xac, 0x8, 0xf4, 0x2e, 0x72, 0xe8, 
  0x34, 0x40, 0x11, 0xd3, 0x20, 0x7b, 0x2f, 0x98, 
  0x56, 0x7d, 0x37, 0x68, 0xe7, 0xe7, 0x2f, 0x84, 
  0x52, 0x50, 0xa4, 0xaa, 0x63, 0xb1, 0xd, 0xca, 
  0xae, 0xba, 0xd2, 0xa2
};
...
bool nf_init() {
  ...
  if (map_allocation_succeeded__1) {
    int vector_alloc_success__4 = vector_locks_allocate(4u, 65536u, ip_addr_allocate, &vector);
    ...
    if (vector_alloc_success__4) {
      int vector_alloc_success__7 = vector_locks_allocate(4u, 65536u, counter_allocate, &vector_1);
      ...
      if (vector_alloc_success__7) {
        ...
        if (is_dchain_allocated__10) {
          int map_allocation_succeeded__13 = map_locks_allocate(touched_port_eq, touched_port_hash, 4194304u, &map_1);
    ...
    if (((6u == ipv4_header_1->next_proto_id) | (17u == ipv4_header_1->next_proto_id)) & ((4294967262u + packet_length) >= 4ul)) {
      ...
      // 153
        ...
        if (0u == map_has_this_key__53) {
          ...
          int out_of_space__56 = !dchain_locks_allocate_new_index(dchain, &new_index__56, now);
          ...
          if (false == ((out_of_space__56) & (0u == number_of_freed_flows__42))) {
            ...
            vector_locks_borrow(vector, new_index__56, (void**)(&vector_value_out));
            ...
            vector_locks_borrow(vector_1, new_index__56, (void**)(&vector_value_out_1));
            vector_value_out_1[0u] = 1u;
            vector_value_out_1[1u] = 0u;
            vector_value_out_1[2u] = 0u;
            vector_value_out_1[3u] = 0u;
            int number_of_freed_flows__61 = expire_items_single_map_iteratively_locks(vector_2, map_1, new_index__56, ((int*)(vector_value_out_1))[0]);
            ...
            vector_locks_borrow(vector_2, 64u * new_index__56, (void**)(&vector_value_out_2));
            ...
            map_locks_put(map_1, vector_value_out_2, 0u);

            if (write_attempt_ptr[0] && (!write_state_ptr[0])) {
              return 1;
            }

            vector_locks_return(vector, new_index__56, vector_value_out);
            vector_locks_return(vector_1, new_index__56, vector_value_out_1);
            vector_locks_return(vector_2, 64u * new_index__56, vector_value_out_2);
            return 1;
          }
        ...
        // 153
          ...
          if (0u == map_has_this_key__86) {
            ...
            if (((int*)(vector_value_out))[0] < 64u) {
              ...
              uint8_t* vector_value_out_1 = 0u;
              vector_locks_borrow(vector_2, (64u * map_value_out) + ((int*)(vector_value_out))[0], (void**)(&vector_value_out_1));
              ...
              vector_locks_return(vector_2, (64u * map_value_out) + ((int*)(vector_value_out))[0], vector_value_out_1);

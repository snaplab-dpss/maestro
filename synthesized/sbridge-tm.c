...
uint8_t hash_key_0[RSS_HASH_KEY_LENGTH] = {
  0x4c, 0xa, 0x3c, 0x2c, 0x3f, 0x2e, 0xff, 0xa8, 
  0x4c, 0x1a, 0xb8, 0xc3, 0xa7, 0xd5, 0xc4, 0x1c, 
  0xaf, 0xc3, 0x26, 0x48, 0x8a, 0xe2, 0x1d, 0xb4, 
  0x98, 0x9e, 0x6c, 0xe5, 0x81, 0xf2, 0xe4, 0xcd, 
  0xfc, 0x21, 0xfa, 0x3b, 0x4f, 0xf9, 0xe3, 0x9b, 
  0x14, 0x9b, 0x5e, 0xbb, 0x71, 0x22, 0xd7, 0x20, 
  0xe6, 0xfd, 0x68, 0x70
};
uint8_t hash_key_1[RSS_HASH_KEY_LENGTH] = {
  0xec, 0xc8, 0x17, 0xfe, 0xfc, 0x8b, 0x4f, 0x95, 
  0x21, 0x3c, 0x35, 0x7a, 0x6b, 0x64, 0x30, 0x0, 
  0x1f, 0x70, 0x74, 0x69, 0xc4, 0xe1, 0x7d, 0xbf, 
  0x3, 0x95, 0xf4, 0x11, 0x68, 0x26, 0x72, 0x54, 
  0xef, 0x89, 0x53, 0xeb, 0x14, 0xa2, 0x80, 0x36, 
  0xde, 0xb6, 0xb0, 0x4a, 0x1a, 0xe0, 0x4a, 0x39, 
  0x50, 0xbe, 0xa2, 0x15
};
      ...
      if (vector_alloc_success__7) {
        ...
        if (map_allocation_succeeded__10) {
          ...
          if (vector_alloc_success__13) {
            int is_dchain_allocated__16 = dchain_tm_allocate(65536u, &dchain);

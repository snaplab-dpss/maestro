...
uint8_t hash_key_0[RSS_HASH_KEY_LENGTH] = {
  0x6f, 0x36, 0x9d, 0x95, 0xca, 0x7f, 0xef, 0x95, 
  0x7f, 0x79, 0xf5, 0x2a, 0x6, 0xb2, 0x58, 0x83, 
  0x21, 0x58, 0x52, 0x3f, 0x47, 0x2f, 0x62, 0xea, 
  0xcf, 0x4a, 0x19, 0x6d, 0x54, 0x23, 0xb6, 0xc3, 
  0x59, 0x54, 0x59, 0x23, 0xd3, 0x48, 0xb9, 0x52, 
  0xc1, 0xae, 0x7c, 0xc7, 0x60, 0xd5, 0x4a, 0x81, 
  0x2d, 0x9c, 0xc1, 0x74
};
uint8_t hash_key_1[RSS_HASH_KEY_LENGTH] = {
  0x7e, 0x91, 0x86, 0xe, 0x46, 0x74, 0x78, 0x4d, 
  0x98, 0x15, 0xee, 0xc2, 0x89, 0xd7, 0x9c, 0x38, 
  0xa8, 0xc9, 0x97, 0x21, 0x4f, 0x6f, 0xb1, 0x56, 
  0x1d, 0x30, 0x8f, 0x32, 0xa8, 0xea, 0x77, 0x26, 
  0x7c, 0xfd, 0x34, 0xc2, 0x71, 0xac, 0xf, 0xa, 
  0xc1, 0xfe, 0xcc, 0x4a, 0xd5, 0x68, 0x83, 0x7d, 
  0x32, 0x1a, 0x9e, 0x81
};
...
int nf_process(uint16_t device, uint8_t* packet, uint16_t packet_length, int64_t now) {
  ...
  if ((8u == ether_header_1->ether_type) & (20ul <= (4294967282u + packet_length))) {
    ...
    int number_of_freed_flows__32 = expire_items_single_map_tm(dchain, vector, map, now - 10000000000ul);
    ...
    // 129
      ...
      if (0u == map_has_this_key__42) {
        ...
        int out_of_space__45 = !dchain_tm_allocate_new_index(dchain, &new_index__45, now);

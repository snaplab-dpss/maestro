...
uint8_t hash_key_0[RSS_HASH_KEY_LENGTH] = {
  0x8b, 0x5e, 0x86, 0x1a, 0xf2, 0xa, 0x7a, 0xf1, 
  0xf6, 0xb2, 0xc4, 0x3b, 0xc9, 0xc5, 0xa5, 0x7a, 
  0x29, 0x42, 0x6c, 0x2d, 0x57, 0xca, 0x67, 0xea, 
  0x88, 0xe, 0x3c, 0x8d, 0xf0, 0xac, 0xa, 0x7b, 
  0xa, 0x90, 0x95, 0xfc, 0x9a, 0xf, 0xed, 0x90, 
  0xc1, 0xb1, 0xcb, 0x8b, 0x77, 0x70, 0x5, 0xa0, 
  0xb2, 0x71, 0xcd, 0x9
};
uint8_t hash_key_1[RSS_HASH_KEY_LENGTH] = {
  0x6d, 0x84, 0xb7, 0xbe, 0xb5, 0x5c, 0xeb, 0x56, 
  0x6b, 0x2b, 0xfc, 0x69, 0xc9, 0x5d, 0x97, 0xcb, 
  0xa6, 0x2a, 0xa1, 0x3d, 0x3e, 0xcc, 0x8b, 0x20, 
  0xaa, 0x37, 0x80, 0x2e, 0x66, 0x9c, 0x80, 0xd3, 
  0x21, 0x38, 0x92, 0xd6, 0x94, 0x7d, 0x2d, 0xff, 
  0xa8, 0x29, 0x68, 0x72, 0x86, 0xff, 0x3d, 0x2c, 
  0x29, 0xde, 0x69, 0x68
};
    ...
    if (((6u == ipv4_header_1->next_proto_id) | (17u == ipv4_header_1->next_proto_id)) & ((4294967262u + packet_length) >= 4ul)) {
      ...
      if (0u != device) {
        ...
        if (0u == map_has_this_key__58) {
          ...
          int32_t prefered_backend_found__62 = cht_tm_find_preferred_available_backend(LoadBalancedFlow_hash__61, vector_4, dchain_1, 97u, 32u, &chosen_backend__62);
          ...
          // 269
            ...
            int out_of_space__73 = !dchain_tm_allocate_new_index(dchain, &new_index__73, now);
        ...
        // 274
          ...
          int32_t dchain_is_index_allocated__125 = dchain_tm_is_index_allocated(dchain_1, ((int*)(vector_value_out))[0u]);
          ...
          // 274
            ...
            int32_t prefered_backend_found__156 = cht_tm_find_preferred_available_backend(LoadBalancedFlow_hash__155, vector_4, dchain_1, 97u, 32u, &chosen_backend__156);
            ...
            // 274
              ...
              int out_of_space__167 = !dchain_tm_allocate_new_index(dchain, &new_index__167, now);
              uint8_t* vector_value_out_2 = 0u;
      ...
      // 277
        ...
        if (0u == map_has_this_key__194) {
          ...
          int out_of_space__197 = !dchain_tm_allocate_new_index(dchain_1, &new_index__197, now);

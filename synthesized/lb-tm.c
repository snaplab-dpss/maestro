...
uint8_t hash_key_0[RSS_HASH_KEY_LENGTH] = {
  0x2f, 0x20, 0x18, 0xdf, 0x3, 0xf2, 0x9a, 0x8e, 
  0xe2, 0xea, 0x61, 0xd8, 0x92, 0x96, 0xa9, 0x67, 
  0x12, 0x83, 0xa1, 0x20, 0x11, 0xf2, 0xcd, 0x83, 
  0xf0, 0xd8, 0xe2, 0xfc, 0xba, 0x87, 0x66, 0xe9, 
  0xa8, 0x7e, 0xc8, 0xab, 0x71, 0x62, 0x39, 0x53, 
  0x4c, 0x9a, 0x2c, 0xde, 0x30, 0xd5, 0x45, 0x42, 
  0x58, 0xe7, 0x63, 0x6a
};
uint8_t hash_key_1[RSS_HASH_KEY_LENGTH] = {
  0xf2, 0x1e, 0xd9, 0xa2, 0x2b, 0x2c, 0x6d, 0xaf, 
  0x4c, 0x46, 0xcc, 0x10, 0xca, 0x50, 0xf3, 0x7a, 
  0x23, 0x29, 0x61, 0xac, 0x1e, 0x97, 0x8b, 0x78, 
  0x7d, 0x18, 0xd3, 0x48, 0x89, 0xf2, 0x5f, 0x7b, 
  0x10, 0x38, 0x1e, 0x3b, 0x64, 0x8b, 0xeb, 0xb1, 
  0xd1, 0xb7, 0xc1, 0x9b, 0x7, 0xb5, 0x16, 0x2a, 
  0xde, 0x77, 0xd7, 0xfd
};
...
bool nf_init() {
  ...
  if (map_allocation_succeeded__1) {
    ...
    if (vector_alloc_success__4) {
      int is_dchain_allocated__7 = dchain_tm_allocate(65536u, &dchain);
          ...
          if (map_allocation_succeeded__13) {
            ...
            if (vector_alloc_success__16) {
              ...
              if (vector_alloc_success__19) {
                int is_dchain_allocated__22 = dchain_tm_allocate(32u, &dchain_1);
                ...
                if (is_dchain_allocated__22) {
                  ...
                  if (vector_alloc_success__25) {
                    int cht_fill_cht_successful__28 = cht_tm_fill_cht(vector_4, 97u, 32u);
...
int nf_process(uint16_t device, uint8_t* packet, uint16_t packet_length, int64_t now) {
  int number_of_freed_flows__45 = expire_items_single_map_tm(dchain, vector, map, now - 100000000000ul);
  int number_of_freed_flows__46 = expire_items_single_map_tm(dchain_1, vector_2, map_1, now - 100000000000ul);
    ...
    if (((6u == ipv4_header_1->next_proto_id) | (17u == ipv4_header_1->next_proto_id)) & ((4294967262u + packet_length) >= 4ul)) {
      ...
      if (0u != device) {
        ...
        if (1u != device) {
          ...
          if (0u == map_has_this_key__60) {
            ...
            int32_t prefered_backend_found__64 = cht_tm_find_preferred_available_backend(LoadBalancedFlow_hash__63, vector_4, dchain_1, 97u, 32u, &chosen_backend__64);
            ...
            // 295
              ...
              int out_of_space__75 = !dchain_tm_allocate_new_index(dchain, &new_index__75, now);
          ...
          // 300
            ...
            int32_t dchain_is_index_allocated__121 = dchain_tm_is_index_allocated(dchain_1, ((int*)(vector_value_out))[0u]);
            ...
            // 300
              ...
              dchain_tm_free_index(dchain, map_value_out);
              ...
              int32_t prefered_backend_found__149 = cht_tm_find_preferred_available_backend(LoadBalancedFlow_hash__148, vector_4, dchain_1, 97u, 32u, &chosen_backend__149);
              ...
              // 300
                ...
                int out_of_space__160 = !dchain_tm_allocate_new_index(dchain, &new_index__160, now);
                uint8_t* vector_value_out_2 = 0u;
        ...
        // 303
          ...
          if (0u == map_has_this_key__184) {
            ...
            int out_of_space__187 = !dchain_tm_allocate_new_index(dchain_1, &new_index__187, now);
          ...
          // 303
            ...
            dchain_tm_rejuvenate_index(dchain_1, map_value_out, now);
            // dropping
            return device;
      ...
      // 306
        ...
        if (0u == map_has_this_key__220) {
          ...
          int out_of_space__223 = !dchain_tm_allocate_new_index(dchain_1, &new_index__223, now);

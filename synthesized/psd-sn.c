...
uint8_t hash_key_0[RSS_HASH_KEY_LENGTH] = {
  0xfc, 0x2, 0x32, 0xc3, 0x0, 0x0, 0x0, 0x0, 
  0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 
  0x5d, 0xf9, 0x89, 0xf6, 0xee, 0xc1, 0x6b, 0x89, 
  0xeb, 0xa8, 0xc4, 0x9a, 0x88, 0x8f, 0x65, 0x80, 
  0xa1, 0xa3, 0x43, 0x64, 0x44, 0xc5, 0x3d, 0xcc, 
  0x8a, 0x64, 0x2b, 0xb9, 0xec, 0xf0, 0x49, 0x49, 
  0xe9, 0xd2, 0x40, 0xd7
};
uint8_t hash_key_1[RSS_HASH_KEY_LENGTH] = {
  0xa8, 0x3d, 0x24, 0x9, 0xe0, 0xd8, 0x9e, 0x38, 
  0xf3, 0x1a, 0xef, 0xd2, 0xe9, 0x51, 0x3d, 0xc, 
  0x67, 0x18, 0xd4, 0x27, 0x10, 0x2f, 0x5b, 0xc2, 
  0x7, 0x32, 0xaa, 0xbc, 0x3b, 0x98, 0xa0, 0xe3, 
  0xd5, 0xc4, 0xed, 0xb5, 0x9c, 0x8b, 0xed, 0x90, 
  0xa5, 0xdc, 0x62, 0x8e, 0x2d, 0xa0, 0x9a, 0x95, 
  0xb8, 0x6e, 0xbc, 0xc8
};
      ...
      if (vector_alloc_success__7) {
        ...
        if (is_dchain_allocated__10) {
          ...
          if (map_allocation_succeeded__13) {
            int vector_alloc_success__16 = vector_allocate(8u, spread_data_among_cores(4194304u), touched_port_allocate, &(*vector_2_ptr));
